"use strict";(self.webpackChunk_proxy_fidelity_landing_page=self.webpackChunk_proxy_fidelity_landing_page||[]).push([[676],{1676:(e,r,a)=>{a.r(r),a.d(r,{default:()=>E});var s=a(1319),n=a(4647),i=a(9281),t=a(6e3),l=a(5043),d=a(9512);const o={name:"",email:"",message:""};function m(e){let r={};return e.name||(r.name="Name is required"),e.email?/\S+@\S+\.\S+/.test(e.email)||(r.email="Email address is invalid"):r.email="Email address is required",e.message||(r.message="Message is required"),r}var c=a(5639),h=a(5527);const p=(0,h.Ay)("p")`
  margin-top: 1.5rem;
`,x=(0,h.Ay)("div")`
  position: relative;
  max-width: 700px;
